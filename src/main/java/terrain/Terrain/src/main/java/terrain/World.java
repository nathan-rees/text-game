...
public class World implements Level
{
	...
	public void encounterFrog()
	{
		Scanner scan =new Scanner(System.in);
		Random rand =new Random();
		if(rand.nextDouble()>0.68&&rand.nextDouble()<0.7)
		{
			System.out.println("Easter egg");
		}
		if(rand.nextDouble()<0.2) //when you encounter a frog
		{
			Frog enemy=new Frog();
			System.out.println("You are being jumped by a frog!");
			...
			if(enemy.isFrogLegsDropped()==true)//see if dropped legs
			{
